...
using FindSimilarServices.Fingerprinting.WorkUnitBuilder;
using FindSimilarServices.Fingerprinting.Hashing;

using FindSimilarServices.Fingerprinting.Dao.Entities;
using FindSimilarServices.Fingerprinting.DbStorage;
using FindSimilarServices.Fingerprinting.DbStorage.Entities;

using FindSimilarServices.Fingerprinting.SoundTools;
...
namespace FindSimilarServices.Fingerprinting
{
    ...
    public class Repository
    {
            ...
            WorkUnitParameterObject param)
        {
            ...
            Debug.WriteLine("Find Similar From Audio Samples - Total Execution Time: {0} ms", t.Stop().TotalMilliseconds);
            return stats;
        }
        ...
        public void FindSimilarFromAudioSamplesList(
            int lshHashTables,
            int lshGroupsPerKey,
            int thresholdTables,
            WorkUnitParameterObject param,
            bool optimizeSignatureCount,
            bool doSearchEverything) // ,SplashSceenWaitingForm splashScreen
        {
            ...
            if (optimizeSignatureCount && fingerprints.Count > MAX_SIGNATURE_COUNT)
            {
                ...
                Debug.WriteLine("Only using the first {0} fingerprints.", MAX_SIGNATURE_COUNT);
            }
            ...
            Dictionary<int, QueryStats> allCandidates = QueryFingerprintManager.QueryOneSongMinHash(
                ...
                thresholdTables,
                ref elapsedMiliseconds,
                doSearchEverything); // ,splashScreen
            ...
            Debug.WriteLine("FindSimilarFromAudioSamplesList - Total Execution Time: {0} ms", t.Stop().TotalMilliseconds);
